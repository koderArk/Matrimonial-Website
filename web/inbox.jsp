<%-- 
    Document   : inbox
    Created on : 14 Feb, 2020, 4:51:41 PM
    Author     : nicar
--%>
 ...
 <%Cookie c[]=request.getCookies();
    ...
    if(email!=null && session.getAttribute(email)!=null){
        try{
            ...
            ResultSet rs=st.executeQuery("select * from inbox where temail='"+temail+"'");
...
while(rs.next()){
                ...
                ResultSet rs1=st1.executeQuery("select * from student where email='"+femail+"'");
            while(rs1.next()){
    fcode=rs1.getString(10);

%>
	                <div class="jobs-item with-thumb">
	                   <div class="thumb_top">
				        <div class="thumb"><a href="view_profile.jsp?code=<%=fcode%>"><img src="images/p13.jpg" class="img-responsive" alt=""/></a></div>
					    <div class="jobs_right">
							<h6 class="title"><a href="view_profile.jsp?code<%=fcode%>"><%=rs1.getString(2)%></a></h6>
							<ul class="top-btns">
							...
							<ul class="login_details1">
							  <li>Message: <%=rs.getString(7)%></li>
							</ul>
							<p class="description">DOB: <%=rs1.getString(3)%>, 5 Ft 7 In / 170 Cms | <span class="m_1">Reliogion</span> : <%=rs1.getString(8)%> | <span class="m_1">Education</span> : B.Tech | <span class="m_1">Occupation</span> : Software Professional<br><a href="view_profile.html" class="read-more">view full profile</a></p>
						</div>
						<div class="clearfix"> </div>
					   </div>
					   <div class="thumb_bottom">
					   	  <div class="thumb"><a href="view_profile.jsp?code=<%=fcode%>" class="photo_view">Add Photo</a></div>
					   	   <div class="thumb_but"><a href="view_profile.jsp?code=<%=fcode%>" class="photo_view">Send Mail</a></div>
					   	  <div class="clearfix"> </div>
					   </div>
					  </div>
<%
