<%-- 
    ...
    Created on : 24 Feb, 2020, 2:02:09 PM
    Author     : nicar
--%>
...
<html>
<head>
<title>Marital an Wedding Category Flat Bootstrap Resposive Website Template | View_profile :: w3layouts</title>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
		        <ul class="nav navbar-nav nav_1">
		            ...
		            <li class="last"><a href="change_password.jsp">Change Password</a></li>
		        </ul>
		     </div><!-- /.navbar-collapse -->
		    </nav>
		   </div> <!-- end pull-right -->
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><%=rs.getString(2)%></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">DOB :</td>
							<td class="day_value"><%=rs.getString(3)%></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Email :</td>
							<td class="day_value"><%=rs.getString(4)%></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><%=rs.getString(8)%></td>
						</tr>
					    <tr class="closed">
							<td class="day_label">Caste :</td>
							<td class="day_value closed"><%=rs.getString(9)%></td>
						</tr>
                                                ...
                                                <form action="message.jsp?code=<%=code%>" method=post>
                                                   
                                                   <div class="form-group">
			                                   <label for="edit-name">Message <span class="form-required" title="This field is required.">*</span></label>
				                           <textarea class="form-control bio" placeholder="" rows="3" name="message"></textarea>
			                            </div>
