<%-- 
    Document   : edit
    Created on : 20 Feb, 2020, 3:31:10 PM
    Author     : nicar
--%>
				...
				<form method=post action='update.jsp'>
		        	<table class="table_working_hours">
		        		...
		        		<tr class="opened_1">
							...
							<td class="day_value">
                                                            <input type='text' name='user' value="<%=rs.getString(2)%>" required>
                                                        </td>
						</tr>
					    <tr class="opened">
							<td class="day_label">DOB :</td>
							<td class="day_value">
                                                            <input type='text' name='date' value="<%=rs.getString(3)%>" required><br>
                                                        </td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Email :</td>
							<td class="day_value">
                                                            <input type='text' name='emailid' value="<%=rs.getString(4)%>" required><br>
                                                        </td>
						</tr>
                                             <tr class="opened">
							<td class="day_label">Gender :</td>
							<td class="day_value">
                                                            <input type='text' name='gender' value="<%=rs.getString(5)%>" required><br>
                                                        </td>
						</tr>    
					    <tr class="opened">
							<td class="day_label">Subject :</td>
							<td class="day_value">
                                                            <input type='text' name='subject' value="<%=rs.getString(6)%>" required><br>
                                                        </td>
						</tr>
					     <tr class="opened">
							<td class="day_label">Religion :</td>
							<td class="day_value">
                                                            <input type='text' name='religion' value="<%=rs.getString(8)%>" required><br>
                                                        </td>
						</tr>
                                             <tr class="opened">
							<td class="day_label">Caste :</td>
							<td class="day_value">
                                                            <input type='text' name='caste' value="<%=rs.getString(9)%>" required><br>
                                                        </td>
						</tr>
