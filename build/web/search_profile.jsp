<%-- 
    ...
    Created on : 21 Feb, 2020, 11:43:39 PM
    Author     : nicar
--%>
...
<%
    ...
    String gender=request.getParameter("gender");
            ...
            ResultSet rs=st.executeQuery("select * from student where caste='"+caste+"' AND religion='"+religion+"' AND gender='"+gender+"'"); 
		        	...
		        	<tbody>
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><%=rs.getString(9)%></td>
                                                   ...
                                                   <Tr><td colspan="2"><a href="view_profile.jsp?code=<%=code%>">view profile</a></td></tr>
				    </tbody>
				</table>
		   <div class="buttons">
